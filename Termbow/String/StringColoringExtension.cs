...
public static class StringColoringExtension
{
    ...
    public static string Normal(this string str)    => str.Paint(ColorValue.Normal);
    public static string Bold(this string str)      => str.Paint(ColorValue.Bold);
    public static string Dim(this string str)       => str.Paint(ColorValue.Dim);
    public static string Italic(this string str)    => str.Paint(ColorValue.Italic);
    public static string Underline(this string str) => str.Paint(ColorValue.Underline);
    public static string Blinking(this string str)  => str.Paint(ColorValue.Blinking);
    public static string Inverse(this string str)   => str.Paint(ColorValue.Inverse);
    public static string Hidden(this string str)    => str.Paint(ColorValue.Hidden);
    public static string Strike(this string str)    => str.Paint(ColorValue.Strike);
}
